...
DEFAULT_OUTPUT = ('/home/cem/colcon_ws/src/viewpoint_planner/figures/viewpoint_plan.png')
...
def build_parser():
    ...
    p.add_argument('--plan', default='/home/cem/colcon_ws/src/viewpoint_planner/plans/viewpoint_plan.json',
