...
from pymoveit2_robot2 import MoveIt2 as MoveIt2_Robot2
from pymoveit2_robot2 import MoveIt2State
from pymoveit2_robot2.robots import ur as robot
...
def main():
    ...
    pose2_joints = [math.radians(130), math.radians(6), math.radians(-100), math.radians(-78), math.radians(-46), math.radians(259)]
    pose3_joints = [math.radians(53), math.radians(-58), math.radians(-97), math.radians(145), math.radians(-32), math.radians(92)]
