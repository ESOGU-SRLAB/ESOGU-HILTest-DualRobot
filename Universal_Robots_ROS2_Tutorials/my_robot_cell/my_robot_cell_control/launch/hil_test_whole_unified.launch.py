        ...
        actions=[
            Node(
                ...
                arguments=[
                    ...
                    # ifarlab.sdf içinde <world name="ifarlab">. Dosya adı "ifarlab" olsa da
                    # dünya adı "ifarlab"; burada "ifarlab" yazılırsa /world/ifarlab/create
                    # servisi hiç var olmaz ve spawn "timed out" ile sessizce düşer.
                    # Robot spawn'ı zaten "-world ifarlab" kullanıyor (yukarıda).
                    "-world", "ifarlab",
...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "world_file",
            default_value="/home/ifarlab/colcon_ws/src/mobile_manipulator_description/worlds/ifarlab.sdf",
